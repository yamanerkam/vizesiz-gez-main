...
export class CountryService {
  private countriesData: Country[] = [
    ...
    },
    {
      ...
      "maxStay": "30 days",
      "notes": "Visa on Arrival is typically granted only for the Iraqi Kurdistan Region. For other regions of Iraq, a visa may be required beforehand."
    },
    {
      "countryName": "Japan",
      "visaType": "Visa Not Required (may vary)",
      "maxStay": "Up to 90 days",
      "notes": "Historically visa-free for Turkish citizens on short visits, but Japan introduced eVisa for certain passport holders. Check most recent regulations."
    },
    {
      "countryName": "Jordan",
    ...
    },
    {
      ...
      "visaType": "Visa on Arrival",
      "maxStay": "90 days",
      "notes": "Free VoA for Turkish citizens at Beirut Rafic Hariri International Airport, subject to conditions (e.g., no Israeli entry stamp)."
    },
    {
    ...
    },
    {
      ...
      "visaType": "Visa Not Required",
      "maxStay": "90 days",
      "notes": "Part of the CA-4 region. Time in Guatemala, El Salvador, Honduras, and Nicaragua is combined."
    },
    {
    ...
    },
    {
      ...
      "visaType": "Visa Not Required",
      "maxStay": "90 days (or indefinite)",
      "notes": "Recognized only by Türkiye; Turkish citizens have unrestricted access. International recognition is limited."
    },
    {
      "countryName": "Oman",
      "visaType": "Visa on Arrival or eVisa",
    ...
    },
    {
      ...
      "visaType": "Visa on Arrival (Visa Exemption Status)",
      "maxStay": "30 days",
      "notes": "Passport must have at least 1 blank page for entry stamp."
    },
    {
      "countryName": "South Korea",
      "visaType": "Visa Not Required (K-ETA required)",
      "maxStay": "90 days",
      "notes": "Turkish citizens may need a K-ETA (electronic travel authorization) prior to boarding. Check the latest rules."
    },
    {
      "countryName": "Sudan",
      "visaType": "Visa on Arrival",
    ...
    {
      "countryName": "Turkish Republic of Northern Cyprus (TRNC)",
      "visaType": "Visa Not Required",
      "maxStay": "No set limit for Turkish citizens",
      "notes": "Recognized only by Türkiye. International flights must connect via Türkiye."
    },
    {
      "countryName": "Ukraine",
      "visaType": "Visa Not Required",
    ...
    },
    {
      ...
      "visaType": "Visa Not Required",
      "maxStay": "90 days",
      "notes": "Can sometimes be extended. Passport must be valid for at least the period of stay."
    },
    {
